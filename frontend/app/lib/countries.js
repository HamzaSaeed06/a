export const countriesData = [
  ...
  { name: "Western Sahara", code: "eh", dial: "+212" },
  { name: "Yemen", code: "ye", dial: "+967" },
  { name: "Zambia", code: "zm", dial: "+260" },
  { name: "Zimbabwe", code: "zw", dial: "+263" },
  // Cricket specific or regions
  { name: "England", code: "gb-eng", dial: "+44" },
  { name: "Scotland", code: "gb-sct", dial: "+44" },
  { name: "Wales", code: "gb-wls", dial: "+44" },
  { name: "West Indies", code: "um", dial: "+1" }, 
];
